...
h1 {
  ...
  font-family: "Lucida Console", "Courier New", monospace;
    ...
    <body style="background-color: rgb(77, 47, 12)">
        ...
        <%
            jb.connect();
            long aux = java.lang.Long.parseLong(request.getParameter("idscriere"));
            String idcarte = request.getParameter("idcarte");
            String idautor = request.getParameter("idautor");
            String durata = request.getParameter("durata");
           	
            String[] valori = {idcarte, idautor, durata};
            String[] campuri = {"idcarte", "idautor", "durata"};
            jb.modificaTabela("autori_carti", "idscriere", aux, campuri, valori);
            jb.disconnect();
        %>
        <p align="center">
				<a href="modifica_Scriere.jsp" class="button button1"><b>Modify another contribution</b></a>
